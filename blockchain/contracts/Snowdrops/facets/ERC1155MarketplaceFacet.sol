...
contract ERC1155MarketplaceFacet is Modifiers {
  ...
  function getERC1155Listings(
    ...
    ///@param _priceInWei The cost price of the NFT individually in $SWDP
    function setERC1155Listing(
      ...
      require(cost >= 1e18, "ERC1155Marketplace: cost should be 1 SWDP or larger");
      ...
      if (s.listingFeeInWei > 0) {
        ...
        LibERC20.transferFrom(s.swdpContract, LibMeta.msgSender(), address(0xFFfFfFffFFfffFFfFFfFFFFFffFFFffffFfFFFfF), s.listingFeeInWei);
      }
    }
    ...
    function executeERC1155Listing(
      ...
      listing.quantity -= _quantity;
      uint256 cost = _quantity * _priceInWei;
      require(IERC20(s.swdpContract).balanceOf(buyer) >= cost, "ERC1155Marketplace: not enough SWDP");
      {
